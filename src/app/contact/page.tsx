...
export const metadata: Metadata = {
  ...
  description: 'Contact DEY GLOBAL EXPORTERS for raw human hair pricing, sample requests, or bulk export inquiries. Reach Sunny Dey and the team based in East Medinipur, West Bengal, India.',
  openGraph: {
    title: 'Contact DEY GLOBAL EXPORTERS | Raw Hair Export Inquiry',
    description: 'Request a price list, ask about MOQs, or discuss your monthly hair supply requirements. Based in East Medinipur, West Bengal, India.',
  },
}
...
const contactDetails = [
  ...
  },
  {
    icon: Clock,
    label: 'Working Hours',
    lines: ['Mon to Sat: 9:00 AM to 7:00 PM IST', 'IST = UTC+5:30'],
    href: null,
  },
]
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[var(--text-muted)] mt-1 leading-relaxed">
                      We respond to all qualified inquiries within 24 business hours. WhatsApp
                      inquiries are typically answered within 2 to 4 hours during working hours.
                    </p>
                  </div>
                </div>
              </div>
