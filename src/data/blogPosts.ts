...
1. Take 5–10 strands from different parts of the bundle.
2. Place them in a glass of water.
3. Observe for 2–3 minutes.

**Genuine raw hair**: Will float initially due to natural oils, then gradually sink as it becomes saturated. This is normal and healthy.

**Processed or coated hair**: Often floats for an unusually long time due to silicone or synthetic coating that repels water. When silicone-coated hair gets wet, it feels unusually silky at first but becomes tangled and matted after the coating washes out.

## The Burn Test: Identifying Synthetic Blends

A small burn test reveals whether the hair is 100% human:

1. Remove 10–15 strands from the bundle.
2. Hold them with tweezers and bring a lighter close.
3. Observe the burn behavior and smell.

**Genuine human hair**: Burns slowly, curls away from the flame, forms a crushable black ash, and smells like burnt protein (similar to burnt fingernails).

**Synthetic blends**: Burns quickly, drips or melts, forms hard beads, and smells like burnt plastic.

## Visual and Tactile Inspection at Scale

When evaluating bulk orders:

**Color consistency**: Natural raw hair from a single temple lot will have very slight tonal variation. Unnatural uniformity — every bundle an identical jet black — suggests acid washing or black dye application, which strips cuticle integrity over time.

**Cuticle alignment check**: Run your fingers from tip to root along a bundle. Genuine Remy hair will feel slightly rough in the tip-to-root direction (like stroking a cat's fur backward) due to cuticle scales facing outward. Processed or stripped hair feels uniformly smooth in both directions because the cuticles have been removed.

**Shedding test**: Gently tug a small section of hair from the bundle. Minimal shedding is normal; excessive shedding of short strands indicates non-Remy mixing or poor wefting.

**Bundle weight consistency**: Weigh 5 random bundles from a lot on a postal scale. Genuine quality-controlled bundles should not deviate more than ±5g from the stated weight. Significant variation indicates inconsistent sourcing or mixing of grades.
...
**Remy hair** preserves this natural cuticle direction. When weft bundles are assembled from Remy hair, all strands run root-to-tip — cuticles aligned. This prevents the scales on adjacent strands from interlocking and tangling with each other.

**Non-Remy hair** is collected and processed without maintaining cuticle direction. Strands face in random directions. To mask this, non-Remy hair is typically acid-washed to strip the cuticle scales entirely, then coated in silicone to produce an artificially smooth surface.
...
*Ready to request samples and pricing? [Contact our team](/contact) today.*
    ...
    date: '2025-02-18',
    readTime: '7 min read',
    image: 'https://kwiecvvnonkolytbwvlv.supabase.co/storage/v1/object/public/Home%20Page%20Images/Blog%20Page/remy_vs_nonremy_hair.png',
...
*Questions about documentation or want a pro-forma invoice? [Contact our export team](/contact).*
    ...
    date: '2025-01-25',
    readTime: '9 min read',
    image: 'https://kwiecvvnonkolytbwvlv.supabase.co/storage/v1/object/public/Home%20Page%20Images/Blog%20Page/blog_hs_code_und.png',
...
**Traceability**: The institutional auction system means temple hair has a cleaner paper trail than informally collected hair. We can trace each lot to the temple auction invoice.
...
*Interested in our temple hair products? [View our product catalog](/products) or [contact us](/contact) for pricing.*
    ...
    image: 'https://kwiecvvnonkolytbwvlv.supabase.co/storage/v1/object/public/Home%20Page%20Images/Blog%20Page/blog_sourcing_story.png',
...
| Product Type | Production Lead Time | Sea Freight (USA) | Sea Freight (EU) | Air Freight |
|--------------|---------------------|-------------------|-----------------|-------------|
| Raw Temple Bulk Hair | 3–7 business days | 25–35 days | 22–30 days | 4–7 days |
| Wefted Bundles (stock) | 5–10 business days | 25–35 days | 22–30 days | 4–7 days |
| Wefted Bundles (custom) | 14–21 business days | 25–35 days | 22–30 days | 4–7 days |
| Lace Closures/Frontals | 10–18 business days | 25–35 days | 22–30 days | 4–7 days |
| Specialty Textures | 14–21 business days | 25–35 days | 22–30 days | 4–7 days |
...
*Ready to discuss your supply chain requirements? [Contact our team](/contact) or reach us on WhatsApp for a faster response.*
    ...
    image: 'https://kwiecvvnonkolytbwvlv.supabase.co/storage/v1/object/public/Home%20Page%20Images/Blog%20Page/blog_best_practices.png',
