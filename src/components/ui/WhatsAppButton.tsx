...
export function WhatsAppButton() {
  const waUrl =
    'https://wa.me/919876543210?text=Hello%20DEY%20GLOBAL%20EXPORTERS%2C%20I%20am%20interested%20in%20your%20raw%20hair%20products.'

  return (
    <div className="fixed bottom-6 right-6 z-50 sm:bottom-6 sm:right-6 bottom-5 right-4 whatsapp-enter">
      <div className="relative group">
        {/* Tooltip */}
        <div className="absolute bottom-full right-0 mb-2 pointer-events-none">
          <span className="block bg-[var(--navy)] text-white text-xs font-medium px-3 py-1.5 rounded-lg whitespace-nowrap opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-200 shadow-lg">
            Chat with us on WhatsApp
            <span className="absolute top-full right-4 -mt-px border-4 border-transparent border-t-[var(--navy)]" />
          </span>
        </div>
        ...
        <a
          ...
          className="glass-whatsapp flex items-center gap-2.5 px-4 py-3 rounded-2xl transition-all duration-200 hover:-translate-y-0.5"
